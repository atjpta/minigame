    ...
    <div>
        <div class="container p-10 mx-auto">
            <div class="relative w-[700px] h-60 mx-auto">
                <div class="absolute w-[10px] inset-y-5 right-1/2 bg-red-500 z-50"></div>
                <div class="w-full h-full scroll-smooth carousel carousel-center rounded-box">
                    <TransitionGroup name="list">
                        <div class="flex mx-[25px]" v-for="i in list" :key="i.id">
                            <img :src="i.url" />
                        </div>
                    </TransitionGroup>
                </div>
        ...
        <div class="flex justify-center m-5">
            <div @click="scrolling()" :class="loading ? 'loading' : ''" class="btn">scroll</div>
        </div>
    </div>
</template>
